...
<template>
  ...
  <table>
    <thead>
      <tr class="flex">
        <th class="flex-auto w-8 text-center">Judul YouTube</th>
        <th class="flex-auto w-64 text-center">Link YouTube</th>
      </tr>
    </thead>
    <tbody>
      <tr v-for="client in itemsPaginated" :key="client.id">
        <td data-label="Nama Vidio Youtube">
          {{ client.title }}
        </td>
        <td data-label="Link Youtube">
          {{ client.content }}
        </td>
