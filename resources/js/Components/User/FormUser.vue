...
<template>
    <CardBox form @submit.prevent="submit">
        ...
        <FormField label="Password" label-for="password" help="Masukkan kata sandi baru">
            <FormControl v-model="form.password" id="password" :icon="mdiLock" type="password"
                autocomplete="new-password" />
        </FormField>

        <FormField label="Role">
            <FormControl v-model="form.role" :options="selectOptions" optionValue="value"
