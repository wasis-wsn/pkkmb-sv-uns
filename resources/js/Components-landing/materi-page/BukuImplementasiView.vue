<template>
    <div>
        <!-- BUKU IMPLEMENTASI -->
        <div v-if="firstMateri && Object.keys(firstMateri).length">
            ...
            <!-- ISI MATERI -->
            <section class="relative flex justify-center items-center pt-16 pb-32 w-full text-2xl font-bold text-black bg-white">
