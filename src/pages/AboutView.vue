  ...
  <header class="flex gap-5 max-md:flex-col max-md:gap-0">
    ...
    >
      ...
      <div class="self-end mt-1 mb-0 max-md:max-w-full">
        ...
        <h1
          class="self-stretch pl-8 mt-5 -mr-1 ml-8 font-bold leading-[20px] text-neutral-900"
        >
          <span class="font-semibold"
            >PKKMB (Pengenalan Kehidupan Kampus bagi Mahasiswa Baru) di Universitas
            ...
            pengenalan fasilitas kampus, pengarahan akademik, dan pengembangan karakter
            untuk membantu mahasiswa baru beradaptasi dengan kehidupan di perguruan
            tinggi.
          </span>
        </h1>
      </div>
    ...
    <div class="timeline-container">
      ...
      <div class="timeline relative">
        ...
        <div class="absolute inset-0 flex justify-center">
          <div class="timeline-line bg-gray-200 w-1"></div>
        </div>
        ...
        <div class="timeline-item flex items-center p-4">
          ...
          <div class="icon w-full sm:w-1/2">
            <div class="icon-wrapper relative w-1/2 mx-auto">
              <img src="@/assets/galeri/p-2.png" alt="Perkenalan Icon" class="rounded-full border-4 border-white shadow-lg" />
            </div>
          </div>
          <div class="text flex flex-col justify-center w-full sm:w-1/2 sm:pl-8">
            <div class="flex items-center">
              <div class="flex justify-center items-center flex-shrink-0 px-5 py-3 text-2xl font-bold text-center text-gray-50 whitespace-nowrap bg-slate-900 h-[50px] rounded-full w-[50px]">
                1
              </div>
        ...
        <div class="timeline-item flex items-center p-4">
          ...
          <div class="icon w-full sm:w-1/2">
            <div class="icon-wrapper relative w-1/2 mx-auto">
              <img src="@/assets/galeri/p-4.png" alt="Pengamalan Icon" class="rounded-full border-4 border-white shadow-lg" />
            </div>
          </div>
          <div class="text flex flex-col justify-center w-full sm:w-1/2 sm:pl-8">
            <div class="flex items-center">
        ...
        <div class="timeline-item flex items-center p-4">
          <div class="timeline-circle bg-red-400 h-8 w-8 rounded-full"></div>
          <div class="icon w-full sm:w-1/2">
            <div class="icon-wrapper relative mx-auto">
              <img src="@/assets/galeri/acara.png" alt="Pemimpin Icon" class="rounded-full border-4 border-white shadow-lg" />
            </div>
          </div>
          <div class="text flex flex-col justify-center w-full sm:w-1/2 sm:pl-8">
            <div class="flex items-center">
        ...
        <div class="timeline-item flex items-center p-4">
          ...
          <div class="icon w-full sm:w-1/2">
            <div class="icon-wrapper relative w-1/2 mx-auto">
              <img src="@/assets/galeri/p-3.png" alt="Kompeten Icon" class="rounded-full border-4 border-white shadow-lg" />
            </div>
          </div>
          <div class="text flex flex-col justify-center w-full sm:w-1/2 sm:pl-8">
            <div class="flex items-center">
              ...
              <h3 class="ml-4 text-4xl font-black text-red-400">KOMPETEN</h3>
            </div>
            <p class="mt-4 text-gray-700 text-lg">
      ...
      <div class="flex flex-wrap justify-center items-center text-center mx-auto">
        <div class="developer m-4 flex flex-col items-center bg-gray-100 p-4 rounded-full shadow-lg hover:shadow-xl transition-shadow duration-300 w-40 h-40">
          <img src="@/assets/dev(ardya)/chamber.png" alt="Wasis Wicaksono" class="foto1 bg-gray-100 w-24 h-24 rounded-full" />
        ...
        <div class="developer m-4 flex flex-col items-center bg-gray-100 p-4 rounded-full shadow-lg hover:shadow-xl transition-shadow duration-300 w-40 h-40">
          <img src="@/assets/dev(ardya)/sova.png" alt="Muhammad Raihan" class="foto1 bg-gray-100 w-24 h-24 rounded-full" />
        ...
        <div class="developer m-4 flex flex-col items-center bg-gray-100 p-4 rounded-full shadow-lg hover:shadow-xl transition-shadow duration-300 w-40 h-40">
          <img src="@/assets/dev(ardya)/chyper.png" alt="Muhamad Prayoga" class="foto1 bg-gray-100 w-24 h-24 rounded-full" />
...
@media (max-width: 768px) {
  ...
  .timeline-line {
    left: 50%;
    transform: translateX(-2px); /* Sesuaikan dengan lebar garis */
